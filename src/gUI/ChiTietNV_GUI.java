...
//		txtThuong.setBounds(1090, 111, 170, 25);
	...
	private void khoiTaoChiTietLuong(String maNV,int Thang,int Nam,String mabp,double khauTru) {
        ...
        for(BangChamCongNV bcc : listBCC) {
            ...
            modelTableChiTietBangLuong.addRow(new Object[] {bcc.getMaCCNV(),dtf.format(bcc.getNgayCham()),bcc.getSoGioTangCa(),bcc.getCaLam()==1?"Sáng":"Tối",bcc.isCoMat(),bcc.isVangMat(),bcc.isCoPhep(),decimalFormat.format(tienCong),bcc.getGhiChu()});
        }
